...
export const tb_programFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tb_programSelect> = z.object({
...
export const tb_programFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    judul: z.boolean().optional(),
    content: z.boolean().optional(),
    uploaded: z.boolean().optional(),
...
export const tb_programFindFirstOrThrowSchema: z.ZodType<Prisma.tb_programFindFirstOrThrowArgs> = z.object({ select: tb_programFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([tb_programOrderByWithRelationInputObjectSchema, tb_programOrderByWithRelationInputObjectSchema.array()]).optional(), where: tb_programWhereInputObjectSchema.optional(), cursor: tb_programWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TbProgramScalarFieldEnumSchema, TbProgramScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tb_programFindFirstOrThrowArgs>;

export const tb_programFindFirstOrThrowZodSchema = z.object({ select: tb_programFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([tb_programOrderByWithRelationInputObjectSchema, tb_programOrderByWithRelationInputObjectSchema.array()]).optional(), where: tb_programWhereInputObjectSchema.optional(), cursor: tb_programWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TbProgramScalarFieldEnumSchema, TbProgramScalarFieldEnumSchema.array()]).optional() }).strict();