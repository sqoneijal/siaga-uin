...
export const tb_link_pendataanFindFirstSelectSchema: z.ZodType<Prisma.tb_link_pendataanSelect> = z.object({
    id: z.boolean().optional(),
    link: z.boolean().optional()
  }).strict() as unknown as z.ZodType<Prisma.tb_link_pendataanSelect>;

export const tb_link_pendataanFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    link: z.boolean().optional()
  }).strict();

export const tb_link_pendataanFindFirstSchema: z.ZodType<Prisma.tb_link_pendataanFindFirstArgs> = z.object({ select: tb_link_pendataanFindFirstSelectSchema.optional(),  orderBy: z.union([tb_link_pendataanOrderByWithRelationInputObjectSchema, tb_link_pendataanOrderByWithRelationInputObjectSchema.array()]).optional(), where: tb_link_pendataanWhereInputObjectSchema.optional(), cursor: tb_link_pendataanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TbLinkPendataanScalarFieldEnumSchema, TbLinkPendataanScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tb_link_pendataanFindFirstArgs>;

export const tb_link_pendataanFindFirstZodSchema = z.object({ select: tb_link_pendataanFindFirstSelectSchema.optional(),  orderBy: z.union([tb_link_pendataanOrderByWithRelationInputObjectSchema, tb_link_pendataanOrderByWithRelationInputObjectSchema.array()]).optional(), where: tb_link_pendataanWhereInputObjectSchema.optional(), cursor: tb_link_pendataanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TbLinkPendataanScalarFieldEnumSchema, TbLinkPendataanScalarFieldEnumSchema.array()]).optional() }).strict();